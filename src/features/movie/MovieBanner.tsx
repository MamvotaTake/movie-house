...
export function MovieBanner() {
        ...
        return <div className='relative'>
                ...
                <div className='absolute top-0 bg-gradient-to-t from-gray-900  to-gray-950/50  w-full h-full'>
                    <div className='flex flex-col cursor-pointer absolute top-1/3 px-5 gap-2 left-2 text-white'>
                        ...
                        <div className="flex w-6/12">
                            <p className='text-white text-sm font-light '>Peter Quill is still trying to find a way to restore his memory after the events of Avengers: Endgame.
